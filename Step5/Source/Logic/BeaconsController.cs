...
namespace Logic
{
    public class BeaconsController: AbstractController, ICommandable, IBeaconsController
    {
        ...
        {
            _dependencyResolver = new DependencyResolver(ConfigParams.FromTuples("dependencies.persistence", "pip-samples-beacons:*:*:1.0"));
        }
        ...
        {
            return _CommandSet ?? new BeaconsCommandSet(this);
        }
